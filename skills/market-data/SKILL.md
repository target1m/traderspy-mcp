---
name: market-data
description: Query real-time crypto futures prices, OHLCV candle data, funding rate / open interest / positioning, and technical indicators (RSI, MACD, EMA, SMA, Bollinger, ATR, ADX, Stochastic, OBV, VWAP, CCI, MFI, Williams %R, ROC, SuperTrend, Ichimoku, Keltner, pivot points, support/resistance) from TraderSpy. Use when the user asks for prices, charts, candles, or technical analysis on crypto pairs.
---
